<template>
  ...
  <div class="auto-sell" v-if="tradeType === 'buy'">
    <div class="auto-sell-label">卖出挂单价：</div>
    <div class="auto-sell-input">
      <input type="number" inputmode="decimal" @input="onAutoSellInputChange" />
  ...
  methods: {
    ...
    onClickTradeButton() {
      ...
      if (this.tradeType === 'buy') {
        ...
        cmd = `/buy ${this.tokenInfo.address} ${this.setting.buy.amount}`
